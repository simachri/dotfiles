...
-- Custom prompt to handle commands.
-- https://awesomewm.org/apidoc/libraries/awful.prompt.html#exe_callback
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "r", custom_prompt,
              {description = "run prompt", group = "launcher"}),
...
awful.rules.rules = {
    ...
    -- Add wiki as custom command
    --{ rule = { class = "Wiki" },
      --properties = { new_tag = "Wiki",
                     --layout = awful.layout.suit.max,
                     --volatile = true, -- remove the tag when the Wiki is closed
    --} },
}
...
-- Enable shared clipboard with host.
