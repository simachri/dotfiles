...
return {
  {
      ...
      keys = {
          ...
          -- Grep live
          { '<leader>gj', '<cmd>lua require("telescope.builtin").live_grep({disable_coordinates=true})<cr>', { noremap = true, silent = true } },
          -- Grep in open buffers
          { '<leader>go', '<cmd>lua require("telescope.builtin").live_grep({grep_open_files=true, disable_coordinates=true, prompt_title="Grep in open buffers"})<cr>', { noremap = true, silent = true } },
          -- Grep word under cursor
          { "<leader>gw", '<cmd>lua require("telescope.builtin").grep_string({ search_dirs = { vim.api.nvim_eval("getcwd()") }})<cr>', { noremap = true, silent = true } },
          ...
          { '<leader>fmh', '<cmd>lua require("telescope.builtin").live_grep({disable_coordinates=true, default_text="## .*", prompt_title="Find header"})<cr>', { noremap = true, silent = true } },
          -- Find help tags
          ...
          { '<leader>fl', '<cmd>lua require("telescope.builtin").resume()<cr>', { noremap = true, silent = true } },
          ...
          { '<leader>fs', '<cmd>lua require("telescope.builtin").lsp_document_symbols({symbol_width=45})<cr>', { noremap = true, silent = true } },
          -- LSP: Find Document symbols - only functions and methods
          { '<leader>ff', '<cmd>lua require("telescope.builtin").lsp_document_symbols({ symbol_width = 45, symbols = {"function", "method"}, prompt_title = "Find functions & methods" })<cr>', { noremap = true, silent = true } },
          -- LSP: Find workspace symbols
          { '<leader>fw', '<cmd>lua require("telescope.builtin").lsp_dynamic_workspace_symbols()<cr>', { noremap = true, silent = true } },
          -- LSP: Show type definition(s) for word under cursor
          { 'gt', '<cmd>lua require("telescope.builtin").lsp_type_definitions()<cr>', { noremap = true, silent = true } },
          ...
          { 'gi', '<cmd>lua require("telescope.builtin").lsp_implementations()<cr>', { noremap = true, silent = true } },
          -- LSP: Go to reference(s)
          { 'gr', '<cmd>lua require("telescope.builtin").lsp_references({include_declaration=false, fname_width=60, show_line=false})<cr>', { noremap = true, silent = true } },

          -- Grep Search history - use <C-e> for the entry to populate the search prompt.
          { '<leader>ghs', '<cmd>lua require("telescope.builtin").search_history()<cr>', { noremap = true, silent = true } },
          -- Grep Command history - use <C-e> for the entry to populate the command prompt.
          { '<leader>ghc', '<cmd>lua require("telescope.builtin").command_history()<cr>', { noremap = true, silent = true } },
