...
alias update_go_npm_pip='gup update && cd ~ && npm update -D && npm audit fix --force && npm outdated -D && pip list --outdated --format=freeze | grep -v '^\-e' | cut -d = -f 1  | xargs -n1 pip install -U'
